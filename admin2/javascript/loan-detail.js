...
//       "/api/admin/loan_request/problem",
//       {
//         method: "POST",
...
const handle_disaprove_loan = async (btn, loan_request) => {
  ...
  try {
    const response = await fetch(
      "https://grandvilleglobalfinance-api.glitch.me/api/admin/loan_request/crud/disaprove",
...
const submit_loan_approval = async (form) => {
  ...
  try {
    const response = await fetch(
     "https://grandvilleglobalfinance-api.glitch.me/api/admin/deposit/approve",
...
(async () => {
  ...
  try {
    const response = await fetch(
       "https://grandvilleglobalfinance-api.glitch.me/api/admin/loan_request/single",
