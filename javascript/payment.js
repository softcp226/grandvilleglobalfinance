...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://grandvilleglobalfinance-api.glitch.me/api/user/create_deposit/fetch",
      // "http://localhost:5000https://grandvilleglobalfinance-api.glitch.meuser/create_deposit/fetch",
